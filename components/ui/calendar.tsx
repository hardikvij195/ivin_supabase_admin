...
function CalendarDayButton({
  ...
  return (
    <Button
      ...
      className={cn(
        // ✅ force white text on purple when selected
        "data-[selected-single=true]:bg-purple-600 data-[selected-single=true]:text-white",
        ...
        "data-[range-middle=true]:bg-purple-100 data-[range-middle=true]:text-purple-700",
